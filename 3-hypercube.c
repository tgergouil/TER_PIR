...
void Hyp3(mpz_t* ALPHA, mpz_t* GAMMA, mpz_t n, int l, mpz_t* BETA, mpz_t g, int k, mpz_t n_square, int i, int j){
...
void sHyp3(mpz_t uu,mpz_t uv,mpz_t vu,mpz_t vv,mpz_t plain, mpz_t n, mpz_t p, mpz_t q, mpz_t c, mpz_t g, mpz_t n_square, mpz_t lambda){
   mpz_t vv1,uu1;
   mpz_inits(vv1, uu1, NULL);

   sHyp2(vu, vv, vv1, n, p, q, c, g, n_square, lambda);
   sHyp2(uu, uv, uu1, n, p, q, c, g, n_square, lambda);
